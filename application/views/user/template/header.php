        ...
        <ul class="navbar-nav sidebar sidebar" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img width="120px" height="50px" src="<?php echo base_url('assets/img/aisin-1.svg'); ?>">
                </div>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTable" class="collapse show" aria-labelledby="headingTable" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?php echo base_url('user/index'); ?>">Data Accident</a>
                    </div>
                </div>
            </li>
